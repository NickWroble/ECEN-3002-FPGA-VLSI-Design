...
module platform_mm_interconnect_0 (
		...
		input  wire [30:0] dma_0_read_master_address,                                //                                  dma_0_read_master.address
		...
		input  wire [30:0] dma_0_control_port_slave_readdata,                        //                                                   .readdata
		output wire [30:0] dma_0_control_port_slave_writedata,                       //                                                   .writedata
	...
	wire    [9:0] dma_0_read_master_translator_avalon_universal_master_0_burstcount;    // dma_0_read_master_translator:uav_burstcount -> dma_0_read_master_agent:av_burstcount
	...
	wire  [111:0] dma_0_control_port_slave_agent_rf_source_data;                        // dma_0_control_port_slave_agent:rf_source_data -> dma_0_control_port_slave_agent_rsp_fifo:in_data
	...
	wire  [111:0] dma_0_control_port_slave_agent_rsp_fifo_out_data;                     // dma_0_control_port_slave_agent_rsp_fifo:out_data -> dma_0_control_port_slave_agent:rf_sink_data
	...
	wire  [110:0] cmd_mux_002_src_data;                                                 // cmd_mux_002:src_data -> pio_0_s1_agent:cp_data
	...
	wire  [110:0] master_0_master_agent_cp_data;                                        // master_0_master_agent:cp_data -> router:sink_data
	...
	wire  [110:0] dma_0_read_master_agent_cp_data;                                      // dma_0_read_master_agent:cp_data -> router_001:sink_data
	...
	wire  [110:0] dma_0_control_port_slave_agent_rp_data;                               // dma_0_control_port_slave_agent:rp_data -> router_002:sink_data
	...
	wire   [92:0] new_sdram_controller_0_s1_agent_rp_data;                              // new_sdram_controller_0_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [110:0] pio_0_s1_agent_rp_data;                                               // pio_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [110:0] router_src_data;                                                      // router:src_data -> master_0_master_limiter:cmd_sink_data
	...
	wire  [110:0] master_0_master_limiter_cmd_src_data;                                 // master_0_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [110:0] rsp_mux_src_data;                                                     // rsp_mux:src_data -> master_0_master_limiter:rsp_sink_data
	...
	wire  [110:0] master_0_master_limiter_rsp_src_data;                                 // master_0_master_limiter:rsp_src_data -> master_0_master_agent:rp_data
	...
	wire  [110:0] router_001_src_data;                                                  // router_001:src_data -> dma_0_read_master_limiter:cmd_sink_data
	wire          router_001_src_ready;                                                 // dma_0_read_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire    [2:0] router_001_src_channel;                                               // router_001:src_channel -> dma_0_read_master_limiter:cmd_sink_channel
	...
	wire  [110:0] dma_0_read_master_limiter_cmd_src_data;                               // dma_0_read_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	wire          dma_0_read_master_limiter_cmd_src_ready;                              // cmd_demux_001:sink_ready -> dma_0_read_master_limiter:cmd_src_ready
	wire    [2:0] dma_0_read_master_limiter_cmd_src_channel;                            // dma_0_read_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	wire          dma_0_read_master_limiter_cmd_src_startofpacket;                      // dma_0_read_master_limiter:cmd_src_startofpacket -> cmd_demux_001:sink_startofpacket
	wire          dma_0_read_master_limiter_cmd_src_endofpacket;                        // dma_0_read_master_limiter:cmd_src_endofpacket -> cmd_demux_001:sink_endofpacket
	wire          rsp_mux_001_src_valid;                                                // rsp_mux_001:src_valid -> dma_0_read_master_limiter:rsp_sink_valid
	wire  [110:0] rsp_mux_001_src_data;                                                 // rsp_mux_001:src_data -> dma_0_read_master_limiter:rsp_sink_data
	wire          rsp_mux_001_src_ready;                                                // dma_0_read_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire    [2:0] rsp_mux_001_src_channel;                                              // rsp_mux_001:src_channel -> dma_0_read_master_limiter:rsp_sink_channel
	wire          rsp_mux_001_src_startofpacket;                                        // rsp_mux_001:src_startofpacket -> dma_0_read_master_limiter:rsp_sink_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                          // rsp_mux_001:src_endofpacket -> dma_0_read_master_limiter:rsp_sink_endofpacket
	wire          dma_0_read_master_limiter_rsp_src_valid;                              // dma_0_read_master_limiter:rsp_src_valid -> dma_0_read_master_agent:rp_valid
	wire  [110:0] dma_0_read_master_limiter_rsp_src_data;                               // dma_0_read_master_limiter:rsp_src_data -> dma_0_read_master_agent:rp_data
	wire          dma_0_read_master_limiter_rsp_src_ready;                              // dma_0_read_master_agent:rp_ready -> dma_0_read_master_limiter:rsp_src_ready
	wire    [2:0] dma_0_read_master_limiter_rsp_src_channel;                            // dma_0_read_master_limiter:rsp_src_channel -> dma_0_read_master_agent:rp_channel
	...
	wire  [110:0] cmd_mux_src_data;                                                     // cmd_mux:src_data -> dma_0_control_port_slave_burst_adapter:sink0_data
	...
	wire  [110:0] dma_0_control_port_slave_burst_adapter_source0_data;                  // dma_0_control_port_slave_burst_adapter:source0_data -> dma_0_control_port_slave_agent:cp_data
	...
	wire    [2:0] new_sdram_controller_0_s1_burst_adapter_source0_channel;              // new_sdram_controller_0_s1_burst_adapter:source0_channel -> new_sdram_controller_0_s1_agent:cp_channel
	...
	wire   [92:0] router_003_src_data;                                                  // router_003:src_data -> new_sdram_controller_0_s1_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                                 // new_sdram_controller_0_s1_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [2:0] router_003_src_channel;                                               // router_003:src_channel -> new_sdram_controller_0_s1_rsp_width_adapter:in_channel
	...
	wire  [110:0] new_sdram_controller_0_s1_rsp_width_adapter_src_data;                 // new_sdram_controller_0_s1_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	wire    [2:0] new_sdram_controller_0_s1_rsp_width_adapter_src_channel;              // new_sdram_controller_0_s1_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire  [110:0] cmd_mux_001_src_data;                                                 // cmd_mux_001:src_data -> new_sdram_controller_0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                                // new_sdram_controller_0_s1_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [2:0] cmd_mux_001_src_channel;                                              // cmd_mux_001:src_channel -> new_sdram_controller_0_s1_cmd_width_adapter:in_channel
	...
	wire   [92:0] new_sdram_controller_0_s1_cmd_width_adapter_src_data;                 // new_sdram_controller_0_s1_cmd_width_adapter:out_data -> new_sdram_controller_0_s1_burst_adapter:sink0_data
	...
	wire    [2:0] new_sdram_controller_0_s1_cmd_width_adapter_src_channel;              // new_sdram_controller_0_s1_cmd_width_adapter:out_channel -> new_sdram_controller_0_s1_burst_adapter:sink0_channel
	...
	wire    [2:0] dma_0_read_master_limiter_cmd_valid_data;                             // dma_0_read_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	wire          dma_0_control_port_slave_agent_rdata_fifo_src_valid;                  // dma_0_control_port_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] dma_0_control_port_slave_agent_rdata_fifo_src_data;                   // dma_0_control_port_slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          dma_0_control_port_slave_agent_rdata_fifo_src_ready;                  // avalon_st_adapter:in_0_ready -> dma_0_control_port_slave_agent:rdata_fifo_src_ready
	...
	platform_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (pll_0_outclk0_clk),                       //       clk.clk
		.reset               (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platform_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (pll_0_outclk0_clk),                       //       clk.clk
		.reset              (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
