...
module platform_mm_interconnect_1 (
		...
		input  wire [12:0] dma_0_write_master_address,                  //                    dma_0_write_master.address
	...
	wire  [12:0] dma_0_write_master_translator_avalon_universal_master_0_address;       // dma_0_write_master_translator:uav_address -> dma_0_write_master_agent:av_address
	...
	wire   [9:0] dma_0_write_master_translator_avalon_universal_master_0_burstcount;    // dma_0_write_master_translator:uav_burstcount -> dma_0_write_master_agent:av_burstcount
	wire         rsp_mux_src_valid;                                                     // rsp_mux:src_valid -> dma_0_write_master_agent:rp_valid
	wire  [89:0] rsp_mux_src_data;                                                      // rsp_mux:src_data -> dma_0_write_master_agent:rp_data
	...
	wire  [12:0] fifo_0_in_agent_m0_address;                                            // fifo_0_in_agent:m0_address -> fifo_0_in_translator:uav_address
	...
	wire  [90:0] fifo_0_in_agent_rf_source_data;                                        // fifo_0_in_agent:rf_source_data -> fifo_0_in_agent_rsp_fifo:in_data
	...
	wire  [90:0] fifo_0_in_agent_rsp_fifo_out_data;                                     // fifo_0_in_agent_rsp_fifo:out_data -> fifo_0_in_agent:rf_sink_data
	...
	wire  [89:0] dma_0_write_master_agent_cp_data;                                      // dma_0_write_master_agent:cp_data -> router:sink_data
	...
	wire  [89:0] fifo_0_in_agent_rp_data;                                               // fifo_0_in_agent:rp_data -> router_001:sink_data
	...
	wire         cmd_mux_src_valid;                                                     // cmd_mux:src_valid -> fifo_0_in_burst_adapter:sink0_valid
	wire  [89:0] cmd_mux_src_data;                                                      // cmd_mux:src_data -> fifo_0_in_burst_adapter:sink0_data
	wire         cmd_mux_src_ready;                                                     // fifo_0_in_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire   [0:0] cmd_mux_src_channel;                                                   // cmd_mux:src_channel -> fifo_0_in_burst_adapter:sink0_channel
	wire         cmd_mux_src_startofpacket;                                             // cmd_mux:src_startofpacket -> fifo_0_in_burst_adapter:sink0_startofpacket
	wire         cmd_mux_src_endofpacket;                                               // cmd_mux:src_endofpacket -> fifo_0_in_burst_adapter:sink0_endofpacket
	wire         fifo_0_in_burst_adapter_source0_valid;                                 // fifo_0_in_burst_adapter:source0_valid -> fifo_0_in_agent:cp_valid
	wire  [89:0] fifo_0_in_burst_adapter_source0_data;                                  // fifo_0_in_burst_adapter:source0_data -> fifo_0_in_agent:cp_data
	wire         fifo_0_in_burst_adapter_source0_ready;                                 // fifo_0_in_agent:cp_ready -> fifo_0_in_burst_adapter:source0_ready
	wire   [0:0] fifo_0_in_burst_adapter_source0_channel;                               // fifo_0_in_burst_adapter:source0_channel -> fifo_0_in_agent:cp_channel
